...
public class MCPMessageProcessor
{
    ...
    {
        _logger.LogInformation("[MCP] Handling ping request");
        return new {
            jsonrpc = "2.0",
            id = mcpMessage.Id,
            result = new { }
    ...
    {
        _logger.LogInformation("[MCP] Handling resources/templates/list request");
    ...
    {
        _logger.LogInformation("[MCP] Handling completion/complete request");
